;  *** Inno Setup version 4.1.8+ Dutch messages ***

;   To download user-contributed translations of this file, go to: ; http://www.jrsoftware.org/is3rdparty.php

;  Dutch messages for Inno Setup Version 4.1.8 by Jordan Russell.   http://www.jrsoftware.org
;  based on previous translation by Frank Fesevur and Default.isl, v 1.53           Feb 25 2004   22:12 GMT+1
  
;  Nederlandstalige berichten voor Inno Setup Versie 4.1.4 gemaakt door Jordan Russell.
;  gebaseerd op voorgaande vertaling van Frank Vesevur en Default.isl, v 1.53       25 Feb. 2004   22:12 GMT+1
...
;[Languages]
;Name: NL; MessagesFile: Compiler:Dutch-4.1.8.isl
...
PowerUserPrivilegesRequired=U moet ingelogd zijn als systeembeheerder of als gebruiker met systeembeheerders rechten, wanneer U dit programma wilt installeren.
...
ButtonNewFolder=&Maak Nieuwe Map

; *** "Select Language" dialog messages
SelectLanguageTitle=Taalkeuze voor de Setup
...
BeveledLabel=
BrowseDialogTitle=Blader Naar Map
...
WizardSelectDir=Kies de doel-locatie
...
SelectStartMenuFolderLabel3=Setup plaatst de snelkoppelingen van het programma in de volgende Start-Menu map.
...
StatusRollback=Veranderingen opslaan...
