...
;Translation made with INI Translator 1.7 (http://initranslator.sourceforge.net)
;*** Inno Setup version 4.0.5+ Swedish messages ***
;
;-------+---------+---------+---------+---------+---------+---------+---------
;Translators notes (for Swedes only :)
;Rev 040226: 4.1.8 av peter3@peter3.com
;Rev 030929: 4.0.5 av peter3@peter3.com
;Rev 030505: 3.0.7 av peter3@peter3.com
;- ändrat "Setup" till "Installation / Installationsprogram"
;- La till en (1) ny text
;- Rättade diverse stav- och meningsbyggnadsfel
...
UninstallAppFullTitle=Avinstallera %1
...
PowerUserPrivilegesRequired=Du måste vara inloggad som Administratör eller Priviligierad användare när du installerar detta program.
...
UninstallAppRunningError=Avinstalleraren har upptäckt att %1 körs för tillfället.%n%nAvsluta alla öppna instanser av programmet nu. Klicka sedan på OK för att gå vidare, eller Avbryt för att avsluta.
...
AboutSetupNote=Svensk översättning är gjord av dickg@go.to 1999, 2002%n%nUppdatering till 3.0.2+ av peter@peterandlinda.com
...
BeveledLabel=
BrowseDialogTitle=Sök mapp
BrowseDialogLabel=Välj en mapp från listan och klicka på OK.
...
WelcomeLabel1=Välkommen till installationsprogrammet för [name]
WelcomeLabel2=Installationsprogrammet kommer att installera [name] på din dator.
WizardPassword=Lösenord
PasswordLabel1=Denna installation är skyddad med lösenord.
PasswordLabel3=Var god ange lösenordet, tryck sedan på Nästa för att fortsätta. Lösenord skiljer på versaler/gemener.
...
SelectDirLabel3=[name] kommer att installeras i följande mapp.
SelectDirBrowseLabel=För att fortsätta, klicka på Nästa. För att välja en annan mapp, klicka på Bläddra.
...
SelectComponentsLabel2=Välj de komponenter som du vill ska installeras; avmarkera de komponenter som du inte vill ha. Tryck på Nästa när du är klar att fortsätta.
...
SelectStartMenuFolderLabel3=Genvägar till programmet kommer att skaps i följande mapp i Startmenyn.
SelectStartMenuFolderBrowseLabel=För att fortsätta, klicka på Nästa. För att välja en annan mapp, klicka på Bläddra.
...
ReadyLabel2a=Tryck på Installera om du vill fortsätta, eller på Tillbaka om du vill se över eller ändra på något.
ReadyLabel2b=Tryck på Installera för att påbörja installationen.
...
ReadyMemoGroup=Startmeny:
ReadyMemoTasks=Övriga installationsuppgifter:
...
;WizardFinished=Setup är nu klar
...
FileExists=Filen finns redan.%n%nVil du skriva över den?
...
UninstallOpenError=Kan inte öppna filen "%1". Kan inte avinstallera
...
UninstallDataCorrupted=Filen "%1" kan inte läsas. Kan inte avinstallera
