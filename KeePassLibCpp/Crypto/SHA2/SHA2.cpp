...
void_ret sha224(unsigned char hval[], const unsigned char data[], unsigned long len)
{   sha224_ctx  cx[1];
...
void_ret sha512_hash(const unsigned char data[], unsigned long len, sha512_ctx ctx[1])
...
void_ret sha384(unsigned char hval[], const unsigned char data[], unsigned long len)
{   sha384_ctx  cx[1];
...
void_ret sha512(unsigned char hval[], const unsigned char data[], unsigned long len)
{   sha512_ctx  cx[1];
